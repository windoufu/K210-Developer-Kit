...
{
    /* Read the DVP interrupt status, if completed, refresh the data of the display address and clear the interrupt flag, otherwise read the camera data*/
...
{  
    ...
    /* Set DVP display address parameters and close interrupt */
